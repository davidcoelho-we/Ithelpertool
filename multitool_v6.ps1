...
function Teste-Multimidia {
    ...
    if ($Microfone) {
        ...
        Write-Host "⚠️ Por favor, fale em seu microfone para um teste prático. Use o Gravador de Voz do Windows." -ForegroundColor Magenta
        Start-Process "ms-windows-store://pdp/?productId=9n4wds1h5d4x" -ErrorAction SilentlyContinue
    } else {
